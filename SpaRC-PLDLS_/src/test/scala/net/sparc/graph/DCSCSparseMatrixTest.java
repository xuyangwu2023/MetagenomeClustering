...
public class DCSCSparseMatrixTest {
    ...
    public void testToCOO() throws Exception {
        ...
        DCSCSparseMatrix mat = DCSCSparseMatrix.from_array(20, 20, arr);
    ...
    public void transpose() throws Exception {
        if (true) { //normal sparse matrix
            ...
            matrix([[4, 0, 0, 0],
                    ...
                    [0, 0, 0, 5]])
                     */
            AbstractCSCSparseMatrix mat0 = DCSCSparseMatrix.sparse(4, 4, row, col, data);
    ...
    public void sparse() {
        if (true) { //normal sparse matrix
            ...
            matrix([[4, 0, 9, 0],
                    ...
                    [0, 0, 0, 5]])
                     */
            DCSCSparseMatrix mat = DCSCSparseMatrix.sparse(4, 4, row, col, data);
        ...
        if (true) { //single row matrix
            ...
            matrix([[4, 0, 9, 0],
                     ...
                     */
            DCSCSparseMatrix mat = DCSCSparseMatrix.sparse(1, 4, row, col, data);
            System.out.println(mat.toString());
    ...
    public void mmult() throws Exception {
        if (true) { //normal sparse matrix
            DCSCSparseMatrix mat1 = null;
            DCSCSparseMatrix mat2 = null;
            {
                int[] row = {0, 3, 1, 0};
                int[] col = {0, 3, 1, 2};
                float[] data = {4, 5, 7, 9};
                ...
                a=np.matrix([[4, 0, 9, 0],
                    ...
                    [0, 0, 0, 5]])
                     */
                mat1 = DCSCSparseMatrix.sparse(4, 4, row, col, data);
                mat1.clear_transient();
            }
            {
                int[] row = {0, 3, 1, 0, 2};
                int[] col = {0, 3, 1, 2, 2};
                ...
                a*b = matrix([[ 16,   0,  54,   0],
                            ...
                            [  0,   0,   0,  25]])
                     */
                mat2 = DCSCSparseMatrix.sparse(4, 4, row, col, data);
                mat2.clear_transient();
            }

            DCSCSparseMatrix mat3 = (DCSCSparseMatrix) mat1.mmult(mat2);
            mat3.clear_transient();
    ...
    public void plus() throws Exception {
        ...
        if (true) {
            DCSCSparseMatrix mat1 = DCSCSparseMatrix.from_array(4, 2, new float[]{0.79074895f, 0.03295443f, 0.101395786f, 0.41718674f, 0.6596278f, 0.0f, 0.0f, 0.0f});
            DCSCSparseMatrix mat2 = DCSCSparseMatrix.from_array(4, 2, to_float(new double[]{0.7317541, 0.72773397, 0.33861917, 0.15735602, 0.12042163, 0.48110846, 0.46385705, 0.4635681}));
...
//            System.out.println(mat3);
        ...
        if (true) {
            ...
            DCSCSparseMatrix mat1 = DCSCSparseMatrix.from_array(4, 2, arr1);
            DCSCSparseMatrix mat2 = DCSCSparseMatrix.from_array(4, 2, arr2);
    ...
    public void divide_byrow() throws Exception {
        ...
        if (true) { //normal sparse matrix
            ...
            matrix([[4, 3, 9, 0],
                     ...
                     */
                mat1 = DCSCSparseMatrix.sparse(1, 4, row, col, data);
            }
            {
                int[] row = {0, 3, 1, 0, 2};
                int[] col = {0, 3, 1, 2, 2};
